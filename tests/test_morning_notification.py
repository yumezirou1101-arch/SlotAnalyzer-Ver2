...
class MorningNotificationTests(unittest.TestCase):
    ...
    def test_yesterday_formal_normal_shows_top10_and_69_summaries(self):
        ...
        self.assertNotIn(">実差枚</th>", message.html)
        self.assertNotIn(">結果</th>", message.html)
        self.assertEqual(message.html.count('width="73%"'), 10)
        self.assertEqual(message.html.count('colspan="3"'), 10)
        self.assertIn("-1,100", message.html)
        self.assertIn("white-space:nowrap\">LOSE</td>", message.html)
        self.assertIn("white-space:nowrap\">Score 79.90</td>", message.html)
        self.assertIn("平均 +200枚 ｜ 勝率 33.3%", message.html)
        self.assertIn("+1,000 33.3% ｜ +2,000 33.3% ｜ 3台", message.html)
        self.assertIn("平均 -340枚 ｜ 勝率 20.0%", message.html)
