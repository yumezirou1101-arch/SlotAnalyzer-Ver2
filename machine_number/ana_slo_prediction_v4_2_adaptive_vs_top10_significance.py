...
INPUT_DIR = BASE_DIR / "data" / "maruhan_maebashi" / "machine_number" / "analysis" / "31days_deep" / "39_Ver4_2_long_term_adaptive_rank_band_fixed"

INPUT_DAILY = INPUT_DIR / "39_Ver4_2_long_term_adaptive_rank_band_fixed_daily.csv"
INPUT_SELECTION = INPUT_DIR / "39_Ver4_2_long_term_adaptive_rank_band_fixed_selection.csv"
...
def load_daily():
    if not INPUT_DAILY.exists():
        raise FileNotFoundError(f"INPUT_DAILY not found:\n{INPUT_DAILY}")
