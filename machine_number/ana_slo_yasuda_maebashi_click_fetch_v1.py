...
# ============================================================
# Yasuda Maebashi - Ana-Slo Link Fetch V1
# ============================================================
#
# V3 change
# ---------
...
#
# Strict machine-count CSV validation remains delegated to:
...
STORE_LIST_URL = "https://ana-slo.com/%e3%83%9b%e3%83%bc%e3%83%ab%e3%83%87%e3%83%bc%e3%82%bf/%e7%be%a4%e9%a6%ac%e7%9c%8c/%e3%82%84%e3%81%99%e3%81%a0%e5%89%8d%e6%a9%8b%e5%ba%97-%e3%83%87%e3%83%bc%e3%82%bf%e4%b8%80%e8%a6%a7/"

DEFAULT_MAX_DAYS = 1
MIN_REASONABLE_MACHINES = 300
EXPECTED_CURRENT_MACHINES = 320
...
def parse_args():
    parser = argparse.ArgumentParser(
        description=(
            "Fetch Yasuda Maebashi Ana-Slo daily pages "
...
def validate_daily_html(
    ...
    return (
        ok,
        {
            ...
            "current_count_match": current_count_match,
        },
    )
...
def save_log(
    ...
    path = (
        LOG_DIR
        / f"yasuda_maebashi_fetch_v1_{stamp}.csv"
    )
    ...
    async with async_playwright() as playwright:
        ...
        for pos, item in enumerate(
            ...
            try:
                ...
                print(
                    f"current count match     : {result['current_count_match']}"
                )
                    ...
                    logs.append(
                        {
                            ...
                            "current_count_match": result["current_count_match"],
                            "title": result["title"],
                            "file": "",
                        }
                    )
        ...
        print()
        print(
            "V1 verifies that the Playwright DOM is actually accessible."
        )
        print(
        ...
        print(
            "Yasuda Maebashi source HTML is stored in its dedicated data directory."
        )
