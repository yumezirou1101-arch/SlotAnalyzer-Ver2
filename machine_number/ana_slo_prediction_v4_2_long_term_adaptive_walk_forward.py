...
def adaptive_main():
    ...
    out_dir = OUT_DIR
    out_daily = out_dir / "38_Ver4_2_long_term_adaptive_rank_band_daily.csv"
    out_block = out_dir / "38_Ver4_2_long_term_adaptive_rank_band_blocks.csv"
    out_selection = out_dir / "38_Ver4_2_long_term_adaptive_rank_band_selection.csv"
    out_summary = out_dir / "38_Ver4_2_long_term_adaptive_rank_band_summary.csv"
    out_diag = out_dir / "38_Ver4_2_long_term_adaptive_rank_band_diagnostic.csv"
    out_monthly = out_dir / "38_Ver4_2_long_term_adaptive_rank_band_monthly.csv"
    ...
    print(out_monthly)
    print()
    print("Ver.4.2 long-term adaptive rank band walk-forward complete.")
