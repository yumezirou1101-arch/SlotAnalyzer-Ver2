...
def main():
    ...
    out_daily = (
        OUT_DIR
        / "48_Ver4_2_rolling_39days_daily.csv"
    )

    out_summary = (
        OUT_DIR
        / "48_Ver4_2_rolling_39days_summary.csv"
    )

    out_ranking = (
        OUT_DIR
        / "48_Ver4_2_rolling_39days_ranking.csv"
    )

    out_top10 = (
        OUT_DIR
        / "48_Ver4_2_rolling_39days_top10_compare.csv"
    )

    out_topn = (
        OUT_DIR
        / "48_Ver4_2_rolling_39days_model_topn.csv"
    )
