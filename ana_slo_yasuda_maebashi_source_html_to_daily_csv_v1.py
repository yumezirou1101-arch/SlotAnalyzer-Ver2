...
EXPECTED_MACHINES = 320
EXPECTED_STORE_NAME = "やすだ前橋店"
...
def convert_one(
    ...
    if store_name != EXPECTED_STORE_NAME:
        raise RuntimeError(
            f"Store mismatch: {store_name!r} != {EXPECTED_STORE_NAME!r}"
        )
...
def main() -> None:
    ...
    if args.source_html:
        ...
        candidates = sorted(
            (PROJECT_ROOT / "data" / "yasuda_maebashi" / "source_html").glob(
